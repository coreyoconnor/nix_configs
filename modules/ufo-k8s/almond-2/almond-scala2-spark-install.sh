...
coursier launch --fork almond:${almond_version} --scala ${scala_full_version} \
      ...
      --arg --predef-code --arg "$(cat /etc/scala2-spark-predef.scala)" #\
...
coursier fetch --scala 2.13 org.apache.spark::spark-sql:${spark_version}
coursier fetch --scala 2.13 sh.almond::ammonite-spark:${ammonite_spark_version}
