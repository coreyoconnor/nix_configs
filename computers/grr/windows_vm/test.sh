...
qemu-kvm -m 24G -M q35 \
         ...
         -device vfio-pci,x-vga=on,multifunction=on,host=04:00.0,bus=root.1,addr=00.0,romfile=./EVGA.GTX470.1280.100416_6.rom \
         -device vfio-pci,host=04:00.1,bus=root.1,addr=00.1 \
         -device vfio-pci,host=09:00.0 -net none \
