...
let
  ...
  globalJupyterService = pkgs.writeShellScript "tensorderp-jupyter-launcher" ''
...
${pkgs.docker}/bin/docker run \
  ...
  '';
  userJupyterService = pkgs.writeShellScript "tensorderp-jupyter-launcher" ''
